    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='is_featured' id='is_featured' value='1' checked> {{__("Yes")}}                        
        </div>
              {{-- {{$categories}} --}}
        ...
        <div class="form-group">
          <label for="price" class="col-form-label">{{__("Price")}}(NRS) <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          ...
          <input id="discount" type="number" name="discount" min="0" max="100" placeholder=""  value="{{old('discount')}}" class="form-control">
          @error('discount')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="S">{{__("Small")}} (S)</option>
              <option value="M">{{__("Medium")}} (M)</option>
              <option value="L">{{__("Large")}} (L)</option>
        ...
        <div class="form-group">
          ...
          <input id="quantity" type="number" name="stock" min="0" placeholder=""  value="{{old('stock')}}" class="form-control">
          @error('stock')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
