    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('product.update', $product->id) }}">
                ...
                <div class="form-group">
                    <label for="summary" class="col-form-label">{{ __('Summary') }} <span
                            class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" name='is_featured' id='is_featured' value='{{ $product->is_featured }}'
                        {{ $product->is_featured ? 'checked' : '' }}> {{ __('Yes') }}
                </div>
                {{-- {{$categories}} --}}
                ...
                <div class="form-group">
                    <label for="price" class="col-form-label">{{ __('Price') }}(NRS) <span
                            class="text-danger">*</span></label>
                    ...
                    <select name="size[]" class="form-control selectpicker" multiple data-live-search="true">
                        ...
                        @foreach ($items as $item)
                            @php
                                ...
                                // dd($data);
                            @endphp
                            <option value="S" @if (in_array('S', $data)) selected @endif>{{ __('Small') }}
                            </option>
                            <option value="M" @if (in_array('M', $data)) selected @endif>{{ __('Medium') }}
                            </option>
                            <option value="L" @if (in_array('L', $data)) selected @endif>{{ __('Large') }}
                            </option>
                ...
                <div class="form-group">
                    ...
                    <select name="condition" class="form-control">
                        ...
                        <option value="default" {{ $product->condition == 'default' ? 'selected' : '' }}>
                            {{ __('Default') }}</option>
                        <option value="new" {{ $product->condition == 'new' ? 'selected' : '' }}>{{ __('New') }}
                        </option>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        <option value="active" {{ $product->status == 'active' ? 'selected' : '' }}>{{ __('Active') }}
                        </option>
