<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{route('banner.index')}}">{{__("Banners")}}</a>
          <a class="collapse-item" href="{{route('banner.create')}}">{{__("Add Banners")}}</a>
        </div>
      </div>
    </li>
    <!-- Divider -->
    ...
    <li class="nav-item">
        ...
        <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">{{__("Brand Options")}}:</h6>
            <a class="collapse-item" href="{{route('brand.index')}}">{{__("Brands")}}</a>
    ...
    <li class="nav-item">
        ...
        <div id="shippingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">{{__("Shipping Options")}}:</h6>
            <a class="collapse-item" href="{{route('shipping.index')}}">{{__("Shipping")}}</a>
            <a class="collapse-item" href="{{route('shipping.create')}}">{{__("Add Shipping")}}</a>
          </div>
        </div>
    </li>
     ...
     <li class="nav-item">
        ...
        <div id="postCategoryCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('post-category.create')}}">{{__("Add Category")}}</a>
          </div>
        </div>
      </li>
    ...
    <li class="nav-item">
        ...
        <div id="tagCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            ...
            <a class="collapse-item" href="{{route('post-tag.create')}}">{{__("Add Tag")}}</a>
            </div>
        </div>
    </li>
