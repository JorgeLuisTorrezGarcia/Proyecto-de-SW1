                    ...
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                        ...
                        <div class="carousel-caption d-none d-md-block text-left">
                            ...
                            <a class="btn btn-lg ws-btn wow fadeInUpBig" href="{{ route('product-grids') }}"
                                role="button">{{ __('Comprar ahora') }}<i
                        ...
                        @if ($cat->is_parent == 1)
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="single-banner">
                                    ...
                                    <div class="content">
                                        <h3>{{ $cat->title }}</h3>
                                        <a href="{{ route('product-cat', $cat->slug) }}">{{ __('Discover Now') }}</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                                                    ...
                                                    <div class="product-action">
                                                        ...
                                                        <a title="Wishlist"
                                                            href="{{ route('add-to-wishlist', $product->slug) }}"><i
                                                                class=" ti-heart "></i><span>{{ __('Add to Wishlist') }}</span></a>
                                                    </div>
                                                    <div class="product-action-2">
                                                        <a title="Add to cart"
                                                            href="{{ route('add-to-cart', $product->slug) }}">{{ __('Add to cart') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="single-banner">
                                ...
                                <div class="content">
                                    ...
                                    <a href="{{ route('product-detail', $data->slug) }}">{{ __('Comprar ahora') }}</a>
                                </div>
                            </div>
                        </div>
                        <!-- /End Single Banner  -->
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            ...
                            <div class="shop-single-blog">
                                ...
                                <div class="content">
                                    ...
                                    <a href="{{ route('blog.detail', $post->slug) }}"
                                        class="more-btn">{{ __('Continue Reading') }}</a>
                                </div>
                            </div>
                            <!-- End Single Blog  -->
                        </div>
