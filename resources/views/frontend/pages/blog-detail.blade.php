                ...
                <div class="col-lg-8 col-12">
                    <div class="blog-single-main">
                        <div class="row">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>Por
                                                ...
                                                href="javascript:void(0);"><i class="fa fa-comments"></i>{{ __('Comment') }}
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group button">
                                                            <button type="submit" class="btn"><span
                                                                    class="comment_btn comment">{{ __('Post Comment') }}</span><span
                                                                    class="comment_btn reply"
                                                                    style="display: none;">{{ __('Reply') }}
                                                                    {{ __('Comment') }}</span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                            ...
                            @else
                                <p class="text-center p-5">
                                    {{ __('You need to') }} <a href="{{ route('login.form') }}"
                                        style="color:rgb(54, 54, 204)">{{ __('Login') }}</a> O
                                    <a style="color:blue" href="{{ route('register.form') }}">{{ __('Register') }}</a> para
                                    comentarios.
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title">{{ __('Comments') }} ({{ $post->allComments->count() }})
                                    </h3>
                                    <!-- Single Comment -->
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">{{ __('Newslatter') }}</h3>
