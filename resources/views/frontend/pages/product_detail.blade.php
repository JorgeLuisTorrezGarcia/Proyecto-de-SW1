                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="">{{ __('Shop Details') }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="nav-main">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                                href="#description" role="tab">{{ __('Description') }}</a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#reviews"
                                                role="tab">{{ __('Reviews') }}</a></li>
                                    </ul>
                                    <!--/ End Tab Nav -->
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="comment-review">
                                                        ...
                                                        <h4>{{ __('Your Rating') }} <span class="text-danger">*</span>
                                                        </h4>
                                                            ...
                                                            @else
                                                                <p class="text-center p-5">
                                                                    {{ __('You need to') }} <a
                                                                        ...
                                                                        style="color:rgb(54, 54, 204)">{{ __('Login') }}</a>
                                                                    {{ __('OR') }} <a style="color:blue"
                                                                        href="{{ route('register.form') }}">{{ __('Register') }}</a>
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View"
                                                    href="#"><i
                                                        class=" ti-eye"></i><span>{{ __('Quick Shop') }}</span></a>
                                                <a title="Wishlist" href="#"><i
                                                        class=" ti-heart "></i><span>{{ __('Add to') }}
                                                        {{ __('Wishlist') }}</span></a>
                                                <a title="Compare" href="#"><i
                                                        class="ti-bar-chart-alt"></i><span>{{ __('Add to Compare') }}</span></a>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <select>
                                                ...
                                                <option>{{ __('black') }}</option>
                                                <option>{{ __('pink') }}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
