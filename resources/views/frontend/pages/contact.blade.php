                ...
                <div class="row">
                    <div class="col-lg-8 col-12">
                        <div class="form-main">
                            ...
                            <h3>{{ __('Write us a message') }} @auth @else<span style="font-size:12px;"
                                    class="text-danger">[ {{ __('You need to login first') }} ]</span>@endauth
                            </h3>
                        </div>
                        <form class="form-contact form contact_form" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="form-group">
                                        <label>{{ __('Your Subjects') }}<span>*</span></label>
