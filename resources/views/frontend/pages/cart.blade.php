                                ...
                                @else
                                    <tr>
                                        <td class="text-center">
                                            {{ __('There are no any carts available') }}. <a
                                                href="{{ route('product-grids') }}"
                                                style="color:blue;">{{ __('Continue shopping') }}</a>
                                    ...
                                    <ul>
                                        ...
                                        @if (session()->has('coupon'))
                                            <li class="coupon_price" data-price="{{ Session::get('coupon')['value'] }}">
                                                {{ __('You Save') }}<span>${{ number_format(Session::get('coupon')['value'], 2) }}</span>
                                            </li>
                                        @endif
                                        @php
                                        ...
                                        @if (session()->has('coupon'))
                                            <li class="last" id="order_total_price">
                                                {{ __('You Pay') }}<span>${{ number_format($total_amount, 2) }}</span></li>
                                        @else
                                            <li class="last" id="order_total_price">
                                                {{ __('You Pay') }}<span>${{ number_format($total_amount, 2) }}</span></li>
                                        @endif
