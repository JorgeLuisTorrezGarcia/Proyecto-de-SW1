                                ...
                                <div class="content">
                                    <ul>
                                        <li class="order_subtotal" data-price="{{ Helper::totalCartPrice() }}">
                                            {{ __('Cart Subtotal') }}<span>${{ number_format(Helper::totalCartPrice(), 2) }}</span>
                                        </li>
                                        <li class="shipping">
                                            {{ __('Shipping Cost') }}
                                        ...
                                        @if (session('coupon'))
                                            <li class="coupon_price" data-price="{{ session('coupon')['value'] }}">
                                                {{ __('You Save') }}<span>${{ number_format(session('coupon')['value'], 2) }}</span>
                                            </li>
                                        @endif
                                        @php
                            ...
                            <div class="single-widget">
                                ...
                                <div class="content">
                                    <div class="checkbox">
                                        ...
                                        <form-group>
                                            <input name="payment_method" type="radio" value="cod"> <label>
                                                {{ __('Cash On Delivery') }}</label><br>
            ...
            <div class="inner-top">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        ...
                        <div class="inner">
                            <h4>{{ __('Newsletter') }}</h4>
                            <p> {{ __('Subscribe to our newsletter and get') }} <span>10%</span>
                                {{ __('off your first purchase') }}</p>
