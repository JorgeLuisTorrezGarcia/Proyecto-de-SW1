        ...
        <div class="card-body">
            <form method="post" action="{{ route('settings.update') }}">
                ...
                <div class="form-group">
                    <label for="short_des" class="col-form-label">{{ __('Short Description') }} <span
                ...
                <div class="form-group">
                    <label for="description" class="col-form-label">{{ __('Description') }} <span
                            class="text-danger">*</span></label>
                ...
                <div class="form-group">
                    <label for="phone" class="col-form-label">{{ __('Phone Number') }} <span
                            class="text-danger">*</span></label>
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#quote').summernote({
                placeholder: "Escribir cotización corta.....",
                tabsize: 2,
                height: 100
            });
        });
