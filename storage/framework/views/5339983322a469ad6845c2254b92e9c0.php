			...
			<div class="row">
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							<li><a href="<?php echo e(('home')); ?>"><?php echo e(__("Home")); ?><i class="ti-arrow-right"></i></a></li>
							<li class="active"><a href="javascript:void(0);"><?php echo e(__("Wishlist")); ?></a></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center"><?php echo e(__("Add to cart")); ?></th> 
							...
							<?php if(Helper::getAllProductFromWishlist()): ?>
								<?php $__currentLoopData = Helper::getAllProductFromWishlist(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$wishlist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										...
										<td><a href="<?php echo e(route('add-to-cart',$wishlist->product['slug'])); ?>" class='btn text-white'><?php echo e(__("Add to cart")); ?></a></td>
							...
							<?php else: ?> 
								<tr>
									<td class="text-center">
										No hay ninguna lista de deseos disponible. <a href="<?php echo e(route('product-grids')); ?>" style="color:blue;">Seguir comprando</a>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-service">
						...
						<p>Pedidos superiores a Bs100</p>
					</div>
					<!-- End Single Service -->
				</div>
				<div class="col-lg-3 col-md-6 col-12">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/pages/wishlist.blade.php ENDPATH**/ ?>