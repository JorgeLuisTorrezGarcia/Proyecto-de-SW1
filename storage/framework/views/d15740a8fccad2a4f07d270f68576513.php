            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            <li><i class="ti-location-pin"></i> <a href="<?php echo e(route('order.track')); ?>">Orden</a>
                            </li>
                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        ...
                        <a href="<?php echo e(route('home')); ?>"><img
                                src="<?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($data->logo); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                    ...
                    <div class="right-bar">
                        ...
                        <div class="sinlge-bar shopping">
                            ...
                            <?php if(session('wishlist')): ?>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                            <a href="<?php echo e(route('wishlist')); ?>" class="single-icon"><i class="fa fa-heart-o"></i> <span
                                    class="total-count"><?php echo e(Helper::wishlistCount()); ?></span></a>
                            <!-- Shopping Item -->
                            <?php if(auth()->guard()->check()): ?>
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        <span><?php echo e(count(Helper::getAllProductFromWishlist())); ?> <?php echo e(__('Items')); ?></span>
                                        <a href="<?php echo e(route('wishlist')); ?>"><?php echo e(__('View Cart')); ?></a>
                                    </div>
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="<?php echo e(route('cart')); ?>" class="btn animate"><?php echo e(__('Cart')); ?></a>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <!--/ End Shopping Item -->
                        ...
                        <div class="sinlge-bar shopping">
                            <a href="<?php echo e(route('cart')); ?>" class="single-icon"><i class="ti-bag"></i> <span
                                    class="total-count"><?php echo e(Helper::cartCount()); ?></span></a>
                            <!-- Shopping Item -->
                            <?php if(auth()->guard()->check()): ?>
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="<?php echo e(route('checkout')); ?>" class="btn animate"><?php echo e(__('Checkout')); ?></a>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <!--/ End Shopping Item -->
                                ...
                                <div class="navbar-collapse">
                                    <div class="nav-inner">
                                        <ul class="nav main-menu menu navbar-nav">
                                            <li class="<?php echo e(Request::path() == 'home' ? 'active' : ''); ?>"><a
                                                    href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?></a></li>
                                            <li class="<?php echo e(Request::path() == 'about-us' ? 'active' : ''); ?>"><a
                                                    href="<?php echo e(route('about-us')); ?>"><?php echo e(__('About Us')); ?></a></li>
                                            <li class="<?php if(Request::path() == 'product-grids' || Request::path() == 'product-lists'): ?> active <?php endif; ?>"><a
                                                    href="<?php echo e(route('product-grids')); ?>"><?php echo e(__('Products')); ?></a><span
                                                    class="new"><?php echo e(__('New')); ?></span></li>
...
<?php /**PATH C:\laragon\www\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>