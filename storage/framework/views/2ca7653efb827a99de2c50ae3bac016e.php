...
<div class="card">
    <h5 class="card-header"><?php echo e(__("Add User")); ?></h5>
    <div class="card-body">
      <form method="post" action="<?php echo e(route('users.store')); ?>">
        <?php echo e(csrf_field()); ?>

        <div class="form-group">
          <label for="inputTitle" class="col-form-label"><?php echo e(__("Name")); ?></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            <label for="inputEmail" class="col-form-label"><?php echo e(__("Email")); ?></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            <label for="inputPassword" class="col-form-label"><?php echo e(__("Password")); ?></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        ?>
        <div class="form-group">
            <label for="role" class="col-form-label"><?php echo e(__("Role")); ?></label>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mb-3">
          <button type="reset" class="btn btn-warning"><?php echo e(__("Reset")); ?></button>
           <button class="btn btn-success" type="submit"><?php echo e(__("Submit")); ?></button>
        </div>
      </form>
    </div>
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Complete-Ecommerce-in-laravel-10-master\resources\views/backend/users/create.blade.php ENDPATH**/ ?>