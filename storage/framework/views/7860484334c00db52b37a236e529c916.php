                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);"><?php echo e(__("Register")); ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row"> 
                <div class="col-lg-6 offset-lg-3 col-12">
                    <div class="login-form">
                        ...
                        <p><?php echo e(__("Please register in order to checkout")); ?></p>
                        <!-- Form -->
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        <button class="btn" type="submit"><?php echo e(__("Register")); ?></button>
                                        <a href="<?php echo e(route('login.form')); ?>" class="btn"><?php echo e(__("Login")); ?></a>
                                        O
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/pages/register.blade.php ENDPATH**/ ?>