                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>Por
                                                <?php echo e($post->author_info['name']); ?></a><a href="javascript:void(0);"><i
                                                    class="fa fa-calendar"></i><?php echo e($post->created_at->format('M d, Y')); ?></a><a
                                                href="javascript:void(0);"><i class="fa fa-comments"></i><?php echo e(__('Comment')); ?>

                                                (<?php echo e($post->allComments->count()); ?>)</a></span>
                                    </div>
                                    <div class="sharethis-inline-reaction-buttons"></div>
                                    <div class="content">
                                        <?php if($post->quote): ?>
                                            <blockquote> <i class="fa fa-quote-left"></i> <?php echo $post->quote; ?>
                                ...
                                <div class="col-12 mt-4">
                                    <div class="reply">
                                        <div class="reply-head comment-form" id="commentFormContainer">
                                            <h2 class="reply-title"><?php echo e(__('Leave a Comment')); ?></h2>
                                            <!-- Comment Form -->
                                            <form class="form comment_form" id="commentForm"
                                                action="<?php echo e(route('post-comment.store', $post->slug)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group button">
                                                            <button type="submit" class="btn"><span
                                                                    class="comment_btn comment"><?php echo e(__('Post Comment')); ?></span><span
                                                                    class="comment_btn reply"
                                                                    style="display: none;"><?php echo e(__('Reply')); ?>

                                                                    <?php echo e(__('Comment')); ?></span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                            ...
                            <?php else: ?>
                                <p class="text-center p-5">
                                    <?php echo e(__('You need to')); ?> <a href="<?php echo e(route('login.form')); ?>"
                                        style="color:rgb(54, 54, 204)"><?php echo e(__('Login')); ?></a> O
                                    <a style="color:blue" href="<?php echo e(route('register.form')); ?>"><?php echo e(__('Register')); ?></a> para
                                    comentarios.
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title"><?php echo e(__('Comments')); ?> (<?php echo e($post->allComments->count()); ?>)
                                    </h3>
                                    <!-- Single Comment -->
                                    <?php echo $__env->make('frontend.pages.comment', [
                                    ...
                                    <div class="content">
                                        ...
                                        <ul class="comment">
                                            <li><i class="fa fa-calendar"
                                                    aria-hidden="true"></i><?php echo e($post->created_at->format('d M, y')); ?></li>
                            ...
                            <div class="letter-inner">
                                ...
                                <form action="<?php echo e(route('subscribe')); ?>" method="POST">
                                    ...
                                    <div class="form-inner">
                                        ...
                                        <button type="submit" class="btn mt-2"><?php echo e(__('Submit')); ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/pages/blog-detail.blade.php ENDPATH**/ ?>