    ...
    <div class="comment-list">
        <div class="single-comment">
            ...
            <h4><?php echo e($comment->user_info['name']); ?> <span>At <?php echo e($comment->created_at->format('g: i a')); ?> On <?php echo e($comment->created_at->format('M d Y')); ?></span></h4>
                ...
                <?php if($dep): ?>
                <div class="button">
                    <a href="#" class="btn btn-reply reply" data-id="<?php echo e($comment->id); ?>"><i class="fa fa-reply" aria-hidden="true"></i><?php echo e(__("Reply")); ?></a>
                    <a href="" class="btn btn-reply cancel" style="display: none;" ><i class="fa fa-trash" aria-hidden="true"></i><?php echo e(__("Cancel")); ?></a>
                </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\laragon\www\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/pages/comment.blade.php ENDPATH**/ ?>