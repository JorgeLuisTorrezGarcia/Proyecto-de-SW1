                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href=""><?php echo e(__('Shop Details')); ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="product-des">
                                ...
                                <div class="short">
                                    ...
                                    <div class="rating-main">
                                        ...
                                        <a href="#"
                                            class="total-review">(<?php echo e($product_detail['getReview']->count()); ?>)
                                    ...
                                    ?>
                                    <p class="price"><span
                                            class="discount">$<?php echo e(number_format($after_discount, 2)); ?></span><s>$<?php echo e(number_format($product_detail->price, 2)); ?></s>
                                    </p>
                                ...
                                <div class="product-buy">
                                    ...
                                    <p class="cat"><?php echo e(__('Category')); ?> :<a
                                    ...
                                    <?php if($product_detail->sub_cat_info): ?>
                                        <p class="cat mt-1"><?php echo e(__('Sub Category')); ?> :<a
                                    ...
                                    <?php endif; ?>
                                    <p class="availability">Stock : <?php if($product_detail->stock > 0): ?>
                                ...
                                <div class="nav-main">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                                href="#description" role="tab"><?php echo e(__('Description')); ?></a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#reviews"
                                                role="tab"><?php echo e(__('Reviews')); ?></a></li>
                                    </ul>
                                    <!--/ End Tab Nav -->
                                </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="comment-review">
                                                        <div class="add-review">
                                                            ...
                                                            <p><?php echo e(__('Your email address will not be published. Required fields are marked')); ?>

                                                            </p>
                                                        </div>
                                                        <h4><?php echo e(__('Your Rating')); ?> <span class="text-danger">*</span>
                                                        </h4>
...
unset($__errorArgs, $__bag); ?>
                                                                        ...
                                                                        <div class="col-lg-12 col-12">
                                                                            <div class="form-group">
                                                                                <label><?php echo e(__('Write a review')); ?></label>
                                                                        ...
                                                                        <div class="col-lg-12 col-12">
                                                                            <div class="form-group button5">
                                                                                <button type="submit"
                                                                                    class="btn"><?php echo e(__('Submit')); ?></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                            <?php else: ?>
                                                                <p class="text-center p-5">
                                                                    <?php echo e(__('You need to')); ?> <a
                                                                        href="<?php echo e(route('login.form')); ?>"
                                                                        style="color:rgb(54, 54, 204)"><?php echo e(__('Login')); ?></a>
                                                                    <?php echo e(__('OR')); ?> <a style="color:blue"
                                                                        href="<?php echo e(route('register.form')); ?>"><?php echo e(__('Register')); ?></a>
                                                    ...
                                                    <div class="ratting-main">
                                                        <div class="avg-ratting">
                                                            ...
                                                            <h4><?php echo e(ceil($product_detail->getReview->avg('rate'))); ?>
                                                                ...
                                                                <span>( <?php echo e(__('Overall')); ?> )</span>
                                                            </h4>
                                                            <span><?php echo e(__('Based on')); ?>

                                                                <?php echo e($product_detail->getReview->count()); ?>

                                                                <?php echo e(__('Comments')); ?></span>
                                                        </div>
                                                                ...
                                                                <div class="rating-des">
                                                                    ...
                                                                    <div class="ratings">
                                                                        ...
                                                                        <div class="rate-count">
                                                                            (<span><?php echo e($data->rate); ?></span>)</div>
                                                                    </div>
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View"
                                                    href="#"><i
                                                        class=" ti-eye"></i><span><?php echo e(__('Quick Shop')); ?></span></a>
                                                <a title="Wishlist" href="#"><i
                                                        class=" ti-heart "></i><span><?php echo e(__('Add to')); ?>

                                                        <?php echo e(__('Wishlist')); ?></span></a>
                                                <a title="Compare" href="#"><i
                                                        class="ti-bar-chart-alt"></i><span><?php echo e(__('Add to Compare')); ?></span></a>
                                            </div>
                                            <div class="product-action-2">
                                                <a title="Add to cart" href="#"><?php echo e(__('Add to cart')); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="product-content">
                                        <h3><a href="<?php echo e(route('product-detail', $data->slug)); ?>"><?php echo e($data->title); ?></a>
                                        </h3>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="quickview-content">
                                <h2><?php echo e(__('Flared Shift Dress')); ?></h2>
                                <div class="quickview-ratting-review">
                                    <div class="quickview-ratting-wrap">
                                        ...
                                        <a href="#"> (1 <?php echo e(__('customer review')); ?>)</a>
                                    </div>
                                    <div class="quickview-stock">
                                        <span><i class="fa fa-check-circle-o"></i> <?php echo e(__('in stock')); ?></span>
                                    </div>
                                </div>
                                <h3>Bs29.00</h3>
                                ...
                                <div class="size">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <select>
                                                <option selected="selected"><?php echo e(__('orange')); ?></option>
                                                <option><?php echo e(__('purple')); ?></option>
                                                <option><?php echo e(__('black')); ?></option>
                                                <option><?php echo e(__('pink')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="add-to-cart">
                                    <a href="#" class="btn"><?php echo e(__('Add to cart')); ?></a>
                                    <a href="#" class="btn min"><i class="ti-heart"></i></a>
                                    <a href="#" class="btn min"><i class="fa fa-compress"></i></a>
                                </div>
                                <div class="default-social">
                                    <h4 class="share-now"><?php echo e(__('Share')); ?>:</h4>
                                    <ul>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/pages/product_detail.blade.php ENDPATH**/ ?>