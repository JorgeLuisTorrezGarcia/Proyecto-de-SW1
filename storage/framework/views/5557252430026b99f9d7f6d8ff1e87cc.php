...
<?php $__env->startSection('main-content'); ?>
    <div class="card">
        <h5 class="card-header"><?php echo e(__('Order')); ?> <a href="<?php echo e(route('order.pdf', $order->id)); ?>"
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-lx-4">
                                <div class="order-info">
                                    <h4 class="text-center pb-4"><?php echo e(__('ORDER INFORMATION')); ?></h4>
                                    <table class="table">
                                        <tr class="">
                                        ...
                                        <tr>
                                            <td><?php echo e(__('Shipping Charge')); ?></td>
                                            <td> : $ <?php echo e($order->shipping->price); ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><?php echo e(__('Payment Method')); ?></td>
                                            <td> : <?php if($order->payment_method == 'cod'): ?>
                            ...
                            <div class="col-lg-6 col-lx-4">
                                <div class="shipping-info">
                                    <h4 class="text-center pb-4"><?php echo e(__('SHIPPING INFORMATION')); ?></h4>
                                    <table class="table">
                                        <tr class="">
                                            <td><?php echo e(__('Full Name')); ?></td>
                                            <td> : <?php echo e($order->first_name); ?> <?php echo e($order->last_name); ?></td>
                                        </tr>
                                        <tr>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Complete-Ecommerce-in-laravel-10-master\resources\views/backend/order/show.blade.php ENDPATH**/ ?>