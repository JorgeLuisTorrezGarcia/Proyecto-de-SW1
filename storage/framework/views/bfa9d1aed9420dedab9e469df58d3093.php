                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);"><?php echo e(__('Shop List')); ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                                ...
                                <div class="price-filter">
                                    <div class="price-filter-inner">
                                        ...
                                        <div class="product_filter">
                                            <button type="submit" class="filter_button"><?php echo e(__('Filter')); ?></button>
                                            <div class="label-input">
                                                <span><?php echo e(__('Range')); ?>:</span>
                            ...
                            <div class="single-widget recent-post">
                                <h3 class="title"><?php echo e(__('Recent post')); ?></h3>
                                ...
                                <?php $__currentLoopData = $recent_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="single-post first">
                                        ...
                                        <div class="content">
                                            ...
                                            ?>
                                            <p class="price"><del
                                                    class="text-muted">$<?php echo e(number_format($product->price, 2)); ?></del>
                                                $<?php echo e(number_format($org, 2)); ?> </p>
                                        </div>
                                    </div>
                                    <!-- End Single Post -->
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <!-- Single Widget -->
                            <div class="single-widget category">
                                <h3 class="title"><?php echo e(__('Brands')); ?></h3>
                                <ul class="categor-list">
                                    <?php
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                                    ...
                                    <div class="shop-shorter">
                                        <div class="single-shorter">
                                            ...
                                            <select class="show" name="show" onchange="this.form.submit();">
                                                ...
                                                <option value="9" <?php if(!empty($_GET['show']) && $_GET['show'] == '9'): ?> selected <?php endif; ?>>09
                                                </option>
                                                <option value="15" <?php if(!empty($_GET['show']) && $_GET['show'] == '15'): ?> selected <?php endif; ?>>15
                                                </option>
                                                <option value="21" <?php if(!empty($_GET['show']) && $_GET['show'] == '21'): ?> selected <?php endif; ?>>21
                                                </option>
                                                <option value="30" <?php if(!empty($_GET['show']) && $_GET['show'] == '30'): ?> selected <?php endif; ?>>30
                                                </option>
                                            </select>
                                        </div>
                                        <div class="single-shorter">
                                            ...
                                            <select class='sortBy' name='sortBy' onchange="this.form.submit();">
                                                <option value=""><?php echo e(__('Default')); ?></option>
                                                <option value="title" <?php if(!empty($_GET['sortBy']) && $_GET['sortBy'] == 'title'): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('Name')); ?></option>
                                                <option value="price" <?php if(!empty($_GET['sortBy']) && $_GET['sortBy'] == 'price'): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('Price')); ?></option>
                                                <option value="category" <?php if(!empty($_GET['sortBy']) && $_GET['sortBy'] == 'category'): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('Category')); ?></option>
                                                <option value="brand" <?php if(!empty($_GET['sortBy']) && $_GET['sortBy'] == 'brand'): ?> selected <?php endif; ?>>
                                                    <?php echo e(__('Brand')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <ul class="view-mode">
                        ...
                        <div class="row">
                            <?php if(count($products)): ?>
                                                ...
                                                <div class="single-product">
                                                    <div class="product-img">
                                                        <a href="<?php echo e(route('product-detail', $product->slug)); ?>">
                                                            ...
                                                            <img class="hover-img" src="<?php echo e($photo[0]); ?>"
                                                                alt="<?php echo e($photo[0]); ?>">
                                                        </a>
                                                        <div class="button-head">
                                                            ...
                                                            <div class="product-action-2">
                                                                <a title="Add to cart"
                                                                    href="<?php echo e(route('add-to-cart', $product->slug)); ?>"><?php echo e(__('Add to cart')); ?></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-8 col-md-6 col-12">
                                                <div class="list-content">
                                                    ...
                                                    <a href="javascript:void(0)" class="btn cart"
                                                        data-id="<?php echo e($product->id); ?>"><?php echo e(__('Buy Now')); ?>!</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                                <h4 class="text-warning" style="margin:100px auto;"><?php echo e(__('There are no products')); ?>.
                                </h4>
                            <?php endif; ?>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            <div class="quickview-ratting-wrap">
                                                ...
                                                <a href="#"> (<?php echo e($rate_count); ?> revisión del cliente)</a>
                                            </div>
                                            <div class="quickview-stock">
                                                <?php if($product->stock > 0): ?>
                                                    <span><i class="fa fa-check-circle-o"></i> <?php echo e($product->stock); ?> en
                                                        stock</span>
                                                <?php else: ?>
                                                    <span><i class="fa fa-times-circle-o text-danger"></i>
                                                        <?php echo e($product->stock); ?> sin stock</span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <?php
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/pages/product-lists.blade.php ENDPATH**/ ?>