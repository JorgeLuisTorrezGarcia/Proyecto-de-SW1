                    ...
                    <div class="carousel-item <?php echo e($key == 0 ? 'active' : ''); ?>">
                        ...
                        <div class="carousel-caption d-none d-md-block text-left">
                            ...
                            <a class="btn btn-lg ws-btn wow fadeInUpBig" href="<?php echo e(route('product-grids')); ?>"
                                role="button"><?php echo e(__('Comprar ahora')); ?><i
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="single-banner">
                                    ...
                                    <div class="content">
                                        ...
                                        <a href="<?php echo e(route('product-cat', $cat->slug)); ?>"><?php echo e(__('Discover Now')); ?></a>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                            ...
                            <ul class="nav nav-tabs filter-tope-group" id="myTab" role="tablist">
                                ...
                                <?php if($categories): ?>
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button class="btn"
                                            style="background:none;color:black;"data-filter=".<?php echo e($cat->id); ?>">
                                            ...
                                            <div class="product-img">
                                                <a href="<?php echo e(route('product-detail', $product->slug)); ?>">
                                                    ...
                                                    <?php if($product->stock <= 0): ?>
                                                        <span class="out-of-stock"><?php echo e(__('Sale out')); ?></span>
                                                    <?php elseif($product->condition == 'new'): ?>
                                                        <span class="new"><?php echo e(__('New')); ?></span
                                                        <?php elseif($product->condition == 'hot'): ?> <span
                                                            class="hot">Hot</span>
                                                    <?php else: ?>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="single-banner">
                                ...
                                <div class="content">
                                    ...
                                    <a href="<?php echo e(route('product-detail', $data->slug)); ?>"><?php echo e(__('Comprar ahora')); ?></a>
                                </div>
                            </div>
                        </div>
                        <!-- /End Single Banner  -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="shop-section-title">
                                <h1><?php echo e(__('Latest Items')); ?></h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    <section class="shop-blog section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2><?php echo e(__('From Our Blog')); ?></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            ...
                            <div class="shop-single-blog">
                                ...
                                <div class="content">
                                    ...
                                    <a href="<?php echo e(route('blog.detail', $post->slug)); ?>"
                                        class="more-btn"><?php echo e(__('Continue Reading')); ?></a>
                                </div>
                            </div>
                            <!-- End Single Blog  -->
                        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-service">
                        ...
                        <p><?php echo e(__('Orders over')); ?> Bs100</p>
                    </div>
                    <!-- End Single Service -->
                </div>
                <div class="col-lg-3 col-md-6 col-12">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/index.blade.php ENDPATH**/ ?>